CREATE TABLE dw_filmstore.d_actor (
...
CREATE TABLE dw_filmstore.d_customer (
...
CREATE TABLE dw_filmstore.f_sales (
...
CREATE TABLE dw_filmstore.d_film (
...
CREATE TABLE dw_filmstore.d_film_actor (
...
CREATE TABLE dw_filmstore.f_payment (
...
CREATE TABLE dw_filmstore.f_rental (
...
CREATE TABLE dw_filmstore.d_store_staff (
