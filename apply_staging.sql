...
sf.rental_rate = ifl.rental_date,
...
insert into stg_sakila.stg_film__category
select * from stg_sakila.int_film__category ifc
where not exists (select 1
                   from stg_sakila.stg_film__category sfc
                   where sfc.category_id= ifc.category_id);


delete from stg_sakila.int_film__category;
commit;
